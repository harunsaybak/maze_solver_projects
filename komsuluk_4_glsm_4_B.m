function [K,new_a,new_b,last,nodus,yol,yonlerim,all_nodus] = komsuluk_4_glsm_4_B(src,a,b,last,nodus,yol,yonlerim,all_nodus)
    ...
    if k4==1 && last ~=4 && yon(4)~=1 % yon~=1 kafani karistirmasi surekli sifirlaniyor
        yon=[0 0 0 1];
        last=2;
        new_a=a+1;
        new_b=b;   
