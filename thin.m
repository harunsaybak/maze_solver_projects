function [BW_Thinned] = thin(mod,resim)

% load image data
%addpath('./data')
if mod==1 
    Img_Original = imread(resim);
    
% Convert gray images to binary images using Otsu's method
Otsu_Threshold = graythresh(Img_Original);
BW_Original = im2bw(Img_Original,Otsu_Threshold);  % must set object region as 1, background region as 0 
